       ...
       @foreach ($grades as $grade)
           ...
           <div class="mt-5 d-flex flex-wrap gap-4" style="margin-left: 10px">
                @foreach ($grade->classrooms as $classroom)
                    <a href="{{ url("/admin/attendances/detail/$classroom->id?date=" . now()->toDateString() )}}" class="d-flex justify-content-center align-items-center text-decoration-none h3"  style="width: 250px; height: 150px; border: 1px solid black;">
